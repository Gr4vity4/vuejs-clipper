<template>
  <div class="js-clipper-basic">
    <div class="vuejs-clipper-basic__padding" :style="padStyle">
      ...
      <div class="vuejs-clipper-basic__in-pad" :style="inPadStyle">
        <div class="vuejs-clipper-basic__clip-area js-clip-area">
          <div class="vuejs-clipper-basic__zoom-area js-zoom-area" :style="posObj">
            <div class="vuejs-clipper-basic__extend vuejs-clipper-basic__extend--outer" :style="exOuterStyle" />
            <div class="vuejs-clipper-basic__extend vuejs-clipper-basic__extend--inner" :style="exInnerStyle">
    ...
    <div class="vuejs-clipper-basic__placeholder" :style="eptStyle">
...
import { map, tap, filter, takeUntil, concatMap, startWith, merge } from "rxjs/operators";
export default {
  extends: {
  ...
  subscriptions() {
    ...
    */
    ...
    this.onChange$ = new Subject().pipe(merge(this.dragSubject$), merge(this.change$));
    return {
      // subscriptions
